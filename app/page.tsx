...
import { CaraKerja } from "@/components/landing/cara-kerja";
    ...
    <div className="animate-content-in">
        ...
        <Reveal>
          <div className="mb-10 text-center">
            ...
            <p className="mt-3 text-base text-muted-foreground">
              Mereka sudah merasakan kemudahan ServisLokal.
            </p>
          </div>
        </Reveal>
          ...
          {[
            {
              ...
              city: "Jakarta",
              rating: 5,
              text: "AC rumah saya tiba-tiba mati tengah malam. Buka ServisLokal, pesan, dan paginya sudah diperbaiki. Harganya jujur, hasilnya rapi.",
              avatar: "R",
            },
            {
              name: "Budi K.",
              city: "Bandung",
              rating: 5,
              text: "Sebagai penyedia jasa listrik, platform ini membantu saya dapat pelanggan baru tanpa biaya. Rating dari pelanggan jadi modal kepercayaan.",
              avatar: "B",
            },
            {
              name: "Ani M.",
              city: "Surabaya",
              rating: 5,
              text: "Pindahan jadi lebih mudah. Bisa bandingkan harga beberapa tukang pindahan, pilih yang paling sesuai. Chat langsung dengan provider juga praktis.",
              avatar: "A",
            },
          ].map((t, i) => (
            <Reveal key={t.name} delay={i * 0.08}>
              <div className="flex h-full flex-col rounded-2xl border border-border bg-card p-6 transition-[transform,box-shadow] duration-200 hover:-translate-y-0.5 hover:shadow-card">
                <div className="flex items-center gap-3">
                  <div className="flex h-10 w-10 items-center justify-center rounded-full bg-primary/15 text-sm font-bold text-primary-strong">
                    {t.avatar}
                  </div>
                  <div>
      ...
      <div className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/80 px-3 py-2.5 pb-[calc(0.625rem+env(safe-area-inset-bottom))] backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 lg:hidden">
        <div className="mx-auto flex max-w-7xl items-center gap-3">
          <span className="shrink-0 text-xs text-muted-foreground">Butuh jasa sekarang?</span>
          <Link href="/services" className="focus-ring flex flex-1 items-center justify-center gap-2 rounded-lg bg-primary px-4 py-2.5 text-sm font-bold text-primary-foreground shadow-glow transition-transform hover:scale-[1.02] active:scale-[0.98]">
            <Search className="h-4 w-4" aria-hidden /> Cari Jasa
          </Link>
        </div>
      </div>
    </div>
